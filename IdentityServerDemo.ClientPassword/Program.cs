...
namespace IdentityServerDemo.ClientPassword
{
    class Program
    {
        ...
        private static async Task CallApiAsync()
        {
            ...
            var tokenClient = new TokenClient(discovery.TokenEndpoint, "ClientPassword", "clientPassword");
            var tokenResponse = await tokenClient.RequestResourceOwnerPasswordAsync("alice", "alice", "IdentityApi");
